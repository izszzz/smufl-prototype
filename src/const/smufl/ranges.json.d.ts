interface Ranges {
  ...
  extendedHelmholtzEllisAccidentalsJustIntonationSupplement: {
    description: "Extended Helmholtz-Ellis accidentals (just intonation) supplement";
    glyphs: [
  ...
  figuredBassSupplement: {
    ...
    glyphs: ["figbass7Diminished", "figbassTripleFlat", "figbassTripleSharp"];
    range_end: "U+ECCF";
    range_start: "U+ECC0";
  };
  fingering: {
  ...
  persianAccidentals: {
    ...
    glyphs: ["accidentalKoron", "accidentalSori"];
    range_end: "U+E46F";
    range_start: "U+E460";
  };
  pluckedTechniques: {
