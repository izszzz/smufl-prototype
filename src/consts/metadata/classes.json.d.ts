interface Classes {
  ...
  accidentalsPersian: ['accidentalKoron', 'accidentalSori'],
  ...
  noteheadSetHeavyX: ['noteheadHeavyX', 'noteheadHeavyXHat'],
  ...
  noteheadSetTriangleLeft: ['noteheadTriangleLeftWhite', 'noteheadTriangleLeftBlack'],
  noteheadSetTriangleRight: ['noteheadTriangleRightWhite', 'noteheadTriangleRightBlack'],
  ...
  parenthesesNotehead: ['noteheadParenthesisLeft', 'noteheadParenthesisRight'],
  pauses: [
    'fermataAbove',
    'fermataBelow',
    'fermataVeryShortAbove',
  ...
  tf_chordSymbols: ['csymDiminished', 'csymHalfDiminished', 'csymAugmented', 'csymMajorSeventh'],
  tf_daseianNotation: [
    'daseianGraves1',
    'daseianGraves2',
    'daseianGraves3',
  ...
  tf_hairpins: ['dynamicCrescendoHairpin', 'dynamicDiminuendoHairpin', 'dynamicMessaDiVoce'],
  tf_harpPedals: ['harpPedalRaised', 'harpPedalCentered', 'harpPedalLowered', 'harpPedalDivider'],
  tf_metronomeMarks: [
    'metNoteDoubleWhole',
  ...
  wigglesArpeggiatoUp: ['wiggleArpeggiatoUp', 'wiggleArpeggiatoUpSwash', 'wiggleArpeggiatoUpArrow'],
  ...
  wigglesQuasiRandom: ['wiggleRandom1', 'wiggleRandom2', 'wiggleRandom3', 'wiggleRandom4'],
  wigglesTrill: [
    'wiggleTrillFastest',
    'wiggleTrillFasterStill',
    'wiggleTrillFaster',
